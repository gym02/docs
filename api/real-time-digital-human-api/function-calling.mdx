...
The `response.function_call_arguments.done` event contains:
- **`arguments`**: The function parameters as a JSON string
- **`call_id`**: A unique identifier for this function call (required when returning results)
</Step>
