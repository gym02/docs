---
title: "WebSocket Events Overview"
...
<CardGroup cols={2}>
  <Card
    ...
    icon="connection"
    href="/api/real-time-digital-human-api/websocket-events/session-events"
  >
  ...
  <Card
    title="Input Events"
    icon="microphone"
    href="/api/real-time-digital-human-api/websocket-events/input-events"
  >
  ...
  <Card
    ...
    icon="message"
    href="/api/real-time-digital-human-api/websocket-events/response-events"
  >
  ...
  <Card
    ...
    icon="code"
    href="/api/real-time-digital-human-api/websocket-events/function-call-events"
  >
  ...
  <Card
    title="Error Events"
    icon="warning"
    href="/api/real-time-digital-human-api/websocket-events/error-events"
  >
    Error notifications and status alerts
  </Card>
</CardGroup>
