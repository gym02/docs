---
title: "Quick Start"
description: "Generate your first digital human video in minutes with the NavTalk Non-real-time Digital Human API"
---

This guide will walk you through generating your first digital human video using the NavTalk Non-real-time Digital Human API.
...
For all 9 supported methods, see the [API Reference](/api/non-real-time-digital-human-api/editor).

## Best Practices

- **Keep videos under 30 seconds** for faster processing
- **Use clear, front-facing images/videos** for optimal results
- **Test with short content first** before generating longer videos
- **Handle errors gracefully** - check for `failed` status and retry if needed
- **Store task IDs** for tracking and debugging

## Next Steps

- Explore all [9 calling methods](/api/non-real-time-digital-human-api/editor)
- Learn about [voice styles](/api/non-real-time-digital-human-api/voice-styles) available for Non-real-time Digital Human API
- Discover [advanced face control parameters](/api/non-real-time-digital-human-api/editor#advanced-face-control-parameters)
